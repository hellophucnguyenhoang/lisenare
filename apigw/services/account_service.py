...
import security
from config import fast_mail, logger
from constants import OTP_EXPIRE_MINUTES
from database import Account, Learner, LearnerSetting
...
def send_otp_by_username(
    ...
    body = (
        ...
        f"  This code expires in <strong>{OTP_EXPIRE_MINUTES} minutes</strong>.<br><br>"
        f"  Best regards,<br>"
